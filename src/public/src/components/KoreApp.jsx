...
function KoreLogo({ size = 32 }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      <div style={{ width: size, height: size, borderRadius: "50%", background: PLUM, display: "flex", alignItems: "center", justifyContent: "center", color: WHITE, fontFamily: "'Playfair Display', serif", fontWeight: 600, fontSize: size * 0.44 }}>K</div>
      <span style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, fontSize: 18, color: TEXT_DARK, letterSpacing: 1 }}>KORE</span>
    </div>
  );
}
...
function Landing({ onStart, onHowItWorks }) {
  return (
    <div style={{ minHeight: "100vh", background: CREAM, padding: 32 }}>
      <div style={{ display: "flex", gap: 48, alignItems: "center", minHeight: "80vh" }}>
        <div style={{ flex: 1 }}>
        ...
        <div style={{ width: 340 }}>
          <div style={{ background: SAGE_DARK, borderRadius: 24, padding: "48px 32px 0", minHeight: 420, display: "flex", flexDirection: "column", overflow: "hidden" }}>
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
              <div style={{ width: 40, height: 2, background: PLUM_LIGHT, marginBottom: 28 }} />
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, color: PLUM_PALE, fontStyle: "italic", marginBottom: 12 }}>The KORE Solution</h2>
              <p style={{ fontSize: 15, color: SAGE_MID, lineHeight: 1.6 }}>Bridging clinical expertise and home convenience.</p>
            </div>
            <div style={{ background: CREAM_DARK, borderRadius: "16px 16px 0 0", padding: "20px 24px", marginTop: 32, textAlign: "center" }}>
              <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, color: PLUM, fontStyle: "italic" }}>"Strength, dignity, empathy, truth."</p>
              <p style={{ fontSize: 12, color: TEXT_MID, marginTop: 6 }}>The four pillars we build around you.</p>
            </div>
          </div>
        </div>
      </div>
